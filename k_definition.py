...
def single_justification_anomaly(data_str, distance, num_instances=None):
    ...
    if num_instances is None:
        num_instances = data.undesired_transformed_test_df.shape[0]
...
def store_anomaly_justification_result(distance):
    ...
    """
    datasets = ['law'] #'adult','kdd_census','german','dutch','bank','credit','compass','diabetes','student','oulad','law','heart','synthetic_athlete','synthetic_disease'
