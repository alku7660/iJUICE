...
datasets = ['dutch','bank','credit','diabetes','ionosphere','student','oulad','law','heart','synthetic_athlete'] # ['adult','kdd_census','german','dutch','bank','credit','compass','diabetes','ionosphere','student','oulad','law','heart','synthetic_athlete','synthetic_disease']
